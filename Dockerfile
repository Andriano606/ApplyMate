...
# docker build -t apply_mate .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name apply_mate apply_mate
...
# Build CSS and JS bundles, then fingerprint with Propshaft
